...
exports.getDetailChat = async (id_sender, id_receiver) => {
  const query =
    `
  SELECT c.id_chat, c.id_receiver, c.id_sender,
  CONCAT("${process.env.PROFILE_PATH}", u1.profile_picture) as sender_profile_picture,
  u1.username as sender_username,
  CONCAT("${process.env.PROFILE_PATH}", u2.profile_picture) as receiver_profile_picture,
